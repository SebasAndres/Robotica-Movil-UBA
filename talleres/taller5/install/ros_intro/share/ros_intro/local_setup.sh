...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/robotica/install/ros_intro"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros_intro/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros_intro/environment/path.sh"
